...
nvprof ./kernel1 -o kernel1_prof_timing1 imagen.txt kernel1_profile1.txt 1
nvprof ./kernel1 -o kernel1_prof_timing2 imagen.txt kernel1_profile2.txt 2
nvprof ./kernel1 -o kernel1_prof_timing3 imagen.txt kernel1_profile3.txt 4
nvprof ./kernel1 -o kernel1_prof_timing4 imagen.txt kernel1_profile4.txt 8
nvprof ./kernel1 -o kernel1_prof_timing5 imagen.txt kernel1_profile5.txt 16
nvprof ./kernel1 -o kernel1_prof_timing6 imagen.txt kernel1_profile6.txt 32
nvprof ./kernel1 -o kernel1_prof_timing7 imagen.txt kernel1_profile7.txt 64
nvprof ./kernel1 -o kernel1_prof_timing8 imagen.txt kernel1_profile8.txt 128
nvprof ./kernel1 -o kernel1_prof_timing9 imagen.txt kernel1_profile9.txt 256
nvprof  ./kernel1 -o kernel1_prof_timing10 imagen.txt kernel1_profile10.txt 512
